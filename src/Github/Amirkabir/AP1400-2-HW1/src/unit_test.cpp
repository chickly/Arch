...
TEST(HW1Test, MULTIPLY2) {
    ...
    EXPECT_THROW(algebra::multiply(Matrix{{1, 2, 3}, {4, 5, 6}}, Matrix{{1, 2,
3}, {4, 5, 6}}), std::logic_error);
}
...
TEST(HW1Test, DETERMINANT1) {
    ...
    EXPECT_THROW(algebra::determinant(Matrix{{1, 2, 3}, {4, 5, 6}}),
std::logic_error);

    // test case
    Matrix matrix{{-1, 1.5, -1.75, -2}, {-2, 2.5, -2.75, -3}, {3, 3.5, -3.75,
-4}, {4, 4.5, 4.75, -5}}; EXPECT_NEAR(algebra::determinant(matrix), -28.5,
0.03);
}

TEST(HW1Test, DETERMINANT2) {
    // test case
    Matrix matrix{{1, 1.5, -1.75, 2}, {2, 2.5, -2.75, 3}, {3, 3.5, -3.75, 4},
{4, 4.5, 4.75, 5}}; EXPECT_DOUBLE_EQ(algebra::determinant(matrix), 0);
}
...
TEST(HW1Test, INVERSE1) {
    ...
    EXPECT_THROW(algebra::inverse(Matrix{{1, 2, 3}, {40, 5, -6}}),
std::logic_error);

    // Caution: singular matrices have no inverse
    Matrix non_singular_matrix{{1, 1.5, -1.75, 2}, {2, 2.5, -2.75, 3}, {3, 3.5,
-3.75, 4}, {4, 4.5, 4.75, 5}};
    EXPECT_THROW(algebra::inverse(non_singular_matrix), std::logic_error);

    // test case
    Matrix matrix{{-1, 1.5, -1.75, -2}, {-2, 2.5, -2.75, -3}, {3, 3.5, -3.75,
-4}, {4, 4.5, 4.75, -5}}; Matrix inverse{algebra::inverse(matrix)};
...
TEST(HW1Test, INVERSE2) {
    // test case
    Matrix matrix{{-12, 1.5, -1.75, -2}, {-2, 2.5, -2.75, -3}, {25, 3.5, -3.75,
-4}, {4, 4.5, 4.75, -51}}; Matrix inverse{algebra::inverse(matrix)};
...
TEST(HW1Test, CONCATENATE1) {
    ...
    EXPECT_THROW(algebra::concatenate(Matrix{{1, 2}}, Matrix{{1, 2, 3}, {4, 5,
6}}, 0), std::logic_error);
...
TEST(HW1Test, UPPER_TRIANGULAR1) {
    ...
    EXPECT_THROW(algebra::upper_triangular(Matrix{{1, 2, 3}, {4, 5, 6}}),
std::logic_error);
